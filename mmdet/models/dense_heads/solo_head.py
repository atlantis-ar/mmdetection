...
class SOLOHead(BaseDenseSegHead):
    ...
    def forward_single(self, x, idx, eval=False, upsampled_size=None):
        ...
        ins_feat = F.interpolate(
            ins_feat, scale_factor=2, mode='bilinear', align_corners=False)
    ...
    def loss(self,
        ...
        ins_labels = [
            torch.cat([
                ins_labels_level_img[ind_level_img, ...]
                for ins_labels_level_img, ind_level_img in zip(
        ...
        ins_preds = [
            torch.cat([
                ins_preds_level_img[ind_level_img, ...]
                for ins_preds_level_img, ind_level_img in zip(
