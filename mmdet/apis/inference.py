# copied newest from https://github.com/WXinlong/mmdetection/blob/SOLO/mmdet/apis/inference.py
import warnings
...
def init_detector(config, checkpoint=None, device='cuda:0'):
    ...
    # WES: added this line
    # WES: check for correct config if e.g. custom classes are used
    model.get(bbox)
...
### WES: so that the img is also saved to disk
    show = False
    ...
    # new code form repo mmdetection master
    # model.show_result(
    #     img,
    #     result,
    #     score_thr=score_thr,
...
### code for result is a tuple, 3; list of tensors
# import warnings
#
# import matplotlib.pyplot as plt
# import mmcv
